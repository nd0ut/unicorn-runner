...
const spec = {
    ...
    entities: [
        ...
        { name: 'enemy', pos: [2317.1666666666615, 323.5], skinName: 'target' },
        ...
        { name: 'enemy', pos: [6168.1666666666615, 225.5], skinName: 'cactus' },
        { name: 'manaPot', pos: [7067.899479945025, 228], skinName: 'default' },
        { name: 'manaPot', pos: [7139.1666666666615, 229], skinName: 'default' },
        {
            name: 'enemy',
            pos: [7780.1666666666615, 27.5],
            skinName: 'target',
            id: 'target-1'
        },
        {
            name: 'enemy',
            pos: [7840.1666666666615, -37.5],
            skinName: 'target',
            id: 'target-2'
        },
        {
...
export default defineLevel(spec, {
    ...
    afterUpdate: (game, level) => {
        ...
        const target2 = level.namedEntities.get('target-2');

        if (!door1.behavior.opened && target1.killable.dead && target2.killable.dead) {
            door1.behavior.open();
        }
    }
});
